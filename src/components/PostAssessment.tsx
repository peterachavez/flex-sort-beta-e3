          ...
          <CardContent className="p-8 text-center">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-gray-200 rounded-lg p-6 mb-8">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                We've analyzed your performance across multiple cognitive flexibility metrics. 
                Choose a report tier to unlock your detailed results, including insights that can 
                inform clinical, educational, or legal decisions.
              </p>
            </div>
